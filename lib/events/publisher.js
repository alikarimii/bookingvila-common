            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // no exchange => rond robin
                        _a.sent();
                        return [4 /*yield*/, this.channel.sendToQueue(this.queueName, Buffer.from(JSON.stringify(data)), {
                                persistent: true,
                            })];
                    case 2:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.channel.assertExchange("my-exchange", "x-delayed-message", {
                                durable: true,
                                arguments: { "x-delayed-type": "direct" },
                            })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.channel.bindQueue(this.queueName, "my-exchange", this.queueName)];
                    case 2:
                        _a.sent();
